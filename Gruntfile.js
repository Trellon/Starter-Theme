module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      options: {
        includePaths: ['bower_components/compass-mixins/lib', 'bower_components/zen-grids/stylesheets', 'bower_components/Sassy-Buttons/stylesheets', 'bower_components/compass-breakpoint/stylesheets'],
        sourceMap: true,
        sourceComments: true
      },
      dist: {
